...
var LineChartController = (function (_super) {
    ...
    function LineChartController() {
        ...
        _this.wrapper.style.cursor = _this.defaultCursor;
        _this.canvas = new LayeredCanvas();
        _this.canvasMarking = _this.canvas.addCanvas();
        _this.canvasMain = _this.canvas.addCanvas();
        _this.canvasLegend = _this.canvas.addCanvas();
        _this.wrapper.appendChild(_this.canvas.wrapper);
        _this.width = _this.canvas.width;
        _this.height = _this.canvas.height;
        _this.canvasMain.strokeStyle = _this.mainColor;
        _this.wrapper.addEventListener("mousedown", function (e) { return _this.wrapper_mouseDown(e); });
        _this.wrapper.addEventListener("mousemove", function (e) { return _this.wrapper_mouseMove(e); });
        _this.wrapper.addEventListener("mouseup", function (e) { return _this.wrapper_mouseUp(e); });
        _this.wrapper.addEventListener("mouseleave", function (e) { return _this.wrapper_mouseLeave(e); });
        _this.wrapper.addEventListener("touchstart", function (e) { return _this.wrapper_touchStart(e); });
        _this.wrapper.addEventListener("touchmove", function (e) { return _this.wrapper_touchMove(e); });
        _this.wrapper.addEventListener("touchend", function (e) { return _this.wrapper_touchEnd(e); });
        _this.wrapper.addEventListener("wheel", function (e) { return _this.zoom(e); });
        _this.wrapper.addEventListener("keydown", function (e) { return _this.wrapper_keyDown(e); });
        _this.wrapper.addEventListener("keyup", function (e) { return _this.wrapper_keyUp(e); });
        _this.updateColors();
        return _this;
    }
